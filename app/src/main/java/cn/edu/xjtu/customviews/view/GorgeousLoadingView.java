...
import cn.edu.xjtu.customviews.util.UiUtils;
...
public class GorgeousLoadingView extends View {
    ...
    public GorgeousLoadingView(Context context, AttributeSet attrs) {
        super(context, attrs);
        mResources = getResources();
        mLeftMargin = UiUtils.dpToPx(context, LEFT_MARGIN);
        mRightMargin = UiUtils.dpToPx(context, RIGHT_MARGIN);
